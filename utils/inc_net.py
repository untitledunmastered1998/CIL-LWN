...
from convs.resnet_imagenet import resnet18_imagenet, resnet34_imagenet
from convs.rep_mobilenet import Rep_MobileNetV2
from convs.resnet_cifar import resnet34_cifar

from convs.mobilenet_v2 import original_mobilenet_v2
...
def get_convnet(args, pretrained=False):
    ...
    # MEMO benchmark backbone
        ...
        return original_mobilenet_v2()

    elif name == 'rep_mobilenetv2':
        return Rep_MobileNetV2(mode='parallel_adapters')

    elif name == 'resnet34_imagenet':
        return resnet34_imagenet()

    elif name == 'resnet34_cifar':
