def get_model(model_name, args):
    ...
    elif name == "offline_static":
        from models.offline_static import Offline_Static
        return Offline_Static(args)
    elif name == "online_static":
        from models.online_static import Online_Static
        return Online_Static(args)
    elif name == "offline_dynamic":
        from models.offline_dynamic import Offline_Dynamic
        return Offline_Dynamic(args)
    elif name == "online_dynamic":
        from models.online_dynamic import Online_Dynamic
        return Online_Dynamic(args)
    else:
        assert 0
