...
class Offline_Static(BaseLearner):
    ...
    def incremental_train(self, data_manager):
        ...
        if self._cur_task == 0:
            ...
            assert self.args["t_ckpt_path"] is not None, "Please provide teacher model checkpoint path."
            self.t_model.load_state_dict(torch.load(self.args["t_ckpt_path"])["model_state_dict"], strict=True)
            self.freeze_teacher()
